...
document.getElementById("child").style.border="1px solid black";
document.getElementById("child").style.height="20px";
document.getElementById("child").style.backgroundColor="red";
